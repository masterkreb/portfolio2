...
if (contactForm) {
  contactForm.addEventListener("submit", function (e) {
    ...
    if (typeof grecaptcha === "undefined" || !grecaptcha.execute) {
      ...
      alert(
        "Der reCAPTCHA-Dienst konnte nicht geladen werden. Bitte überprüfen Sie Ihre Internetverbindung und versuchen Sie es erneut.",
      );
      return;
    }
      ...
      grecaptcha
        ...
        .then(function (token) {
          ...
          if (recaptchaResponse) {
            ...
            alert(
              "Ein interner Fehler ist aufgetreten. Das Formular konnte nicht gesendet werden.",
            );
          }
        })
        .catch(function (error) {
          ...
          alert(
            "Bei der reCAPTCHA-Überprüfung ist ein Fehler aufgetreten. Bitte versuchen Sie es erneut.",
          );
        });
    });
  });
